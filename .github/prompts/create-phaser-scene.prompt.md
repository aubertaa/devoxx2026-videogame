---
description: 'Scaffold and register a new TypeScript-typed Phaser Scene with standard structure and EventBus/Vue integration to ensure consistent, communicative game states when adding new levels, menus, or UI overlay scenes.'
agent: 'agent'
---
